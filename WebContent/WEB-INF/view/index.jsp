...
<html lang="en-US">
    <head>
		...
		<script src="${pageContext.request.contextPath}/resources/js/recommendedmovies.jsp" type="text/script"></script>
							...
							<div class="col-md-12 col-lg-12 hidden-xs hidden-sm" style="height: 450px;">
								...
								<nav>
									<ul class="control-box pager" style="margin-left: -10px; margin-top: -55px;">
										...
										<li><a data-slide="next" href="#myCarouselnowP" class=""><i class="glyphicon glyphicon-chevron-right" style="color:#FF4D4D;"></i></a></li>
									</ul>
								</nav>	
							...
							<div class="col-md-12 col-lg-12 hidden-xs hidden-sm" style="height: 450px; margin-top: -50px;">
								...
								<nav>
									<ul class="control-box pager" style="margin-left: -10px; margin-top: -55px;">
										...
										<li><a data-slide="next" href="#myCarouselupC" class=""><i class="glyphicon glyphicon-chevron-right" style="color:#FF4D4D;"></i></a></li>
									</ul>
								</nav>
