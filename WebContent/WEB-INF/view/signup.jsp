                ...
                <div class="container">
                    ...
                    <ul class="nav navbar-nav navbar-right">
                        ...
                        <c:if test = "${loginedUser.username == null}">
         					<li class="active"><a href="#" onclick="window.location.href='signup'; return false;"><span class="glyphicon glyphicon-user" style="color: #ff4d4d"></span> Sign up</a></li>
            ...
            <div class="container transparent-white" style="padding-top: 50px; padding-bottom: 75px;" >
                ...
                <form:form action="registerUser" modelAttribute="user" method="POST">
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <h2 class="primaryColor">Sign up for new account</h2>
                            <hr>
                        </div>
                    </div>
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                <div class="input-group mb-2 mr-sm-2 mb-sm-0">
                                    ...
                                    <form:password path="passwordConf" cssClass="form-control" cssStyle="width: 600px;" required="required"/>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class ="row">
                        ...
                        <div class="col-md-6">
                        	<label for="password">${registerMessage}</label>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-md-3"></div>
