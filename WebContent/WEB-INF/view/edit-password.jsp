			...
			<div class="row" style="background-color: white;">
				<div class="container" align="center" style="padding-top: 10px; padding-bottom: 10px;">
					<nav>
						...
						<a href="/cinemind//profile/password" class="profileNavBtn profileActivePage">PASSWORD</a>
				...
				<div class="container" style="padding-left: 30px; background-color: white; margin-top: 30px; min-height: 400px;">
					<div class="col-md-12">
						<div class="page-header" style="padding-bottom: 0px;">
							<h3 style="color: #FF4D4D; font-weight: normal;">Change Your Password</h3>
						</div>
					</div>
					<div class="col-md-12">
						<form:form action="changePass" modelAttribute="user" method="POST">
							<div class="row" style="margin-top: -15px;">
		                    	<div class="col-md-12">
		                    		<h5 style="color: red;">${changePassMsgNegative}</h5>
		                    		<h5 style="color: green;">${changePassMsgPositive}</h5>
		                    	</div>
		                    </div>
		                    <div class="row">
		                        ...
		                        <div class="col-md-12">
		                            <div class="form-group">
		                                <div class="input-group mb-2 mr-sm-2 mb-sm-0">
		                                    ...
		                                    <form:password path="passwordConf" cssClass="form-control" cssStyle="width: 50vw; position: relative;" required="required"/>
		                                </div>
		                            </div>
		                        </div>
		                    </div>
		                    <div class="row">
		                        ...
		                        <div class="col-md-12">
		                            <div class="form-group">
		                                <div class="input-group mb-2 mr-sm-2 mb-sm-0">
		                                    <div class="input-group-addon" style="width: 2.6rem"><i class="fa fa-key"></i></div>
		                                    <form:password path="newPass" cssClass="form-control" cssStyle="width: 50vw; position: relative;" required="required"/>
		                                </div>
		                            </div>
		                        </div>
		                    </div>
		                    <div class="row">
		                        ...
		                        <div class="col-md-12">
		                            <div class="form-group">
		                                <div class="input-group mb-2 mr-sm-2 mb-sm-0">
		                                    <div class="input-group-addon" style="width: 2.6rem"><i class="fa fa-key"></i></div>
		                                    <form:password path="newPassConf" cssClass="form-control" cssStyle="width: 50vw; position: relative;" required="required"/>
		                                </div>
		                            </div>
		                        </div>
		                    </div>
