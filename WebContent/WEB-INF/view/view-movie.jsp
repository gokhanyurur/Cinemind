...
<html lang="en-US">
    <head>
		...
		<script src="${pageContext.request.contextPath}/resources/js/recommendedmovies.js"></script>	
	...
	<body>
		...
		<div class="row" style="margin-top: -20px; background-color: black;">
		    <div class="col-md-12">
				<img src="${movie.backdrop_path}" alt="" class="movie-backdrop-header transparent"/>
		    </div>
		</div>
		<!-- content -->
			...
			<div class="container" style="background-color: white;">
				<div class="row" style="margin-top: 20px;">
									...
									<c:if test="${actor.imagePath != null}">
										<div class="col-md-6 col-xs-6 actor-container">
											<div class="col-md-3 col-xs-5">
												<img src="${actor.imagePath}" alt="Performer" style="width: 60px; height: auto;"/>
											</div>
							...
							<div class="col-md-12">
								...
								<c:forEach var="trailer" items="${movie.videoList}">
									<div class="col-md-4" style="margin-bottom: 20px;">
										<div class="vid">
							                <iframe width="560" height="315" src="//www.youtube.com/embed/${trailer.key}" allowfullscreen="true"></iframe>
							            </div>
									</div>	
								</c:forEach>
							</div>
					...
					<div class="col-md-3">
						...
						<div class="col-md-6 col-xs-6">
							<div class="col-md-8 col-xs-4">
								<img style="width: 40px; height: auto;" src="${pageContext.request.contextPath}/resources/img/logo.png" alt="Cinemind Logo"/>
							</div>
							<div class="col-md-4 col-xs-8" style="margin-top: -15px; margin-left: -15px;">
						...
						<div class="col-md-12">
							<nav>
								<ul class="control-box pager" style="margin-left: -10px; margin-top: -15px; margin-left: -10px; margin-bottom: 80px;">
									...
									<li><a data-slide="next" href="#myCarouselrec" class=""><i class="glyphicon glyphicon-chevron-right" style="color:#FF4D4D;"></i></a></li>
								</ul>
							</nav>
						</div>
					</div>
