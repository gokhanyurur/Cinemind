...
<html lang="en-US">
	<head>
		...
		<script src="${pageContext.request.contextPath}/resources/js/recommendedmovies.js" type="text/script"></script>
	...
	<body>
	        	...
	        	<div class="container">
	                ...
	                <ul class="nav navbar-nav navbar-right">
	                	<li style="padding-left: 5px; padding-right: 5px;">
	                    	<form:form action="/cinemind/search" modelAttribute="q" method="GET" class="navbar-form">
		...
		<div class="row" style="margin-top: -40px; background-color: #e5e5e5">
			<div class="container" style="padding: 30px; background-color: white">
	            		...
	            		<header>
	            			<div class="col-md-12">
		            			<div class="page-header" style="padding-bottom: 0px;">
									<h3 style="color: #FF4D4D; font-weight: normal;">Movies of ${actorName}</h3>
								</div>
		            		</div>
	            		</header>					
						<div class="col-md-12 hidden-xs hidden-sm">
	            			<ul class="thumbnails" style="margin-left: -50px;"> 
		            			<c:forEach var="tempMovie" items="${actorMoviesList}">
				...
				<div class="row">
					<c:if test="${(fn:length(actorMoviesList) > 0) and (totalPages > 1)}">
						<div class="col-md-12" align="center">
							<a href="/cinemind/movies/actor/${actorId}?page=1" class="pageText" style="margin-right: 5px;">1</a>
					    	...
					    	<c:forEach var="i" begin="2" end="${totalPages}" step="1">
								<c:url var="pageLink" value="/movies/actor/${actorId}">
							...
							<c:if test="${param.page != totalPages}">
								<a href="/cinemind/movies/actor/${actorId}?page=${totalPages}" class="pageText" style="margin-right: 5px;">${totalPages}</a>
							</c:if>	
						</div>
					</c:if>
				</div>
